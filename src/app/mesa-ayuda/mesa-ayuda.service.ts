...
export class MesaAyudaService {
  ...
  getTickets():Promise<Ticket[] | null>{
    ...
    this. tickets=  [
      new Ticket(1, 101, 1, 1, 'Problema de red', 'No se puede acceder a la red', 'alguien@algo.com', new Date('2023-08-01'), new Date('2023-08-16'), 1, 2),
      new Ticket(2, 102, 2, 4, 'Error en la aplicación', 'La aplicación se bloquea al iniciar', 'alguien@algo.com', new Date('2023-08-02'), new Date('2023-08-10'), 2, 1),
      new Ticket(3, 103, 1, 2, 'Solicitud de hardware', 'Necesito una nueva computadora', 'alguien@algo.com', new Date('2023-08-03'), new Date('2023-08-18'), 1, 3),
      new Ticket(4, 104, 3, 7, 'Problema de impresión', 'No se imprimen los documentos', 'alguien@algo.com', new Date('2023-08-04'), new Date('2023-08-19'), 1, 2),
      new Ticket(5, 105, 2, 5, 'Error en la página web', 'El sitio web muestra un error al cargar', 'alguien@algo.com', new Date('2023-08-05'), new Date('2023-08-12'), 3, 1),
      new Ticket(6, 106, 1, 3, 'Solicitud de software', 'Necesito instalar un nuevo programa', 'alguien@algo.com', new Date('2023-08-06'), new Date('2023-08-21'), 1, 3),
      new Ticket(7, 107, 4, 8, 'Problema de correo electrónico', 'No recibo correos electrónicos', 'alguien@algo.com', new Date('2023-08-07'), new Date('2023-08-22'), 1, 2),
      new Ticket(8, 108, 2, 6, 'Error en el formulario', 'El formulario de contacto no funciona', 'alguien@algo.com', new Date('2023-08-08'), new Date('2023-08-15'), 2, 1),
    ];
    return this.tickets; */
  }
  ...
  filtrar(filtros: any):Ticket[] | null{
    ...
    let tickets=  [
    new Ticket(1, 101, 1, 1, 'Problema de red', 'No se puede acceder a la red', 'alguien@algo.com', new Date('2023-08-01'), new Date('2023-08-16'), 1, 2),
    new Ticket(2, 102, 2, 3, 'Error en la aplicación', 'La aplicación se bloquea al iniciar', 'alguien@algo.com', new Date('2023-08-02'), new Date('2023-08-10'), 2, 1),
    new Ticket(3, 103, 1, 2, 'Solicitud de hardware', 'Necesito una nueva computadora', 'alguien@algo.com', new Date('2023-08-03'), new Date('2023-08-18'), 1, 3)];
    return tickets;
  }

...
export class CRUDTicketsComponent implements OnInit{
  ...
  getTicket(id:number,mostrar:boolean) {
    ...
    if (this.ticket) {
      ...
      this.servicio_MesaAyuda.getCategoria_ID(this.ticket?.id_categoria).then(data => {
        this.txt_categoria = data;
      });
      this.servicio_MesaAyuda.getItem_ID(this.ticket?.id_item).then(data => {
        this.txt_item = data;
      });
      this.txt_estado = this.servicio_MesaAyuda.getEstado_ID(this.ticket?.id_estado);
      this.servicio_MesaAyuda.getResponsable_ID(this.ticket?.email_responsable)?.then(data => {
  ...
  verTicket(id_ticket:number,mostrar:boolean) {
    ...
    if (this.ticket) {
      ...
      this.remitente = this.servicio_MesaAyuda.getRemitente_ID(this.ticket?.id_usuario);
      this.servicio_MesaAyuda.getCategoria_ID(this.ticket?.id_categoria).then(async(categoria) => {
        this.txt_categoria = categoria;
      });
      this.servicio_MesaAyuda.getItem_ID(this.ticket?.id_item).then(data => {
        this.txt_item = data;
      });
